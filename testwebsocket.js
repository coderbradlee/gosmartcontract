...
///////////////////////////////////////////////////////
    ...
    const mepAddress =
    '0x9fAB5a8e28327D75E720fB190852F04368188D62';
    web3 = new Web3()
    const eventProvider = new Web3.providers.WebsocketProvider('ws://13.113.9.175:28546')
    ...
    // filter: {event:'onEndTx'}, // Using an array means OR: e.g. 20 or 23
    // fromBlock: 0
