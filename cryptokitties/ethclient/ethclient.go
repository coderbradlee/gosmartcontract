...
func (ec *Client) GetAccounts(ctx context.Context) ([]string, error) {
	...
	var reply []string
	err := ec.c.CallContext(ctx, &reply, "eth_accounts")
	return reply, err
}

func (ec *Client) SendTransaction2(ctx context.Context, from, to, gas, gasPrice, value string, autoGas bool) (string, error) {
