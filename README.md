...
solc --bin --abi --optimize -o . --allow-paths /root/gosmartcontract/erc721 /root/gosmartcontract/erc721/tokens/nf-token.sol   /////ok

abigen -abi NFToken.abi -bin NFToken.bin --pkg=erc721 --out=erc721.go   ///ok
