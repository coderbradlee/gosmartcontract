...
/*
 * -PlayerBook - v0.0.1© Magic Power Inc. 2018
 */
...
interface MagicPowerDevsInterface {
...
contract PlayerBook {
    ...
    MagicPowerForwarderInterface constant private MagicPowerForwarder = MagicPowerForwarderInterface(0xDdc5f4eb3540cEFC8684Be2F2331F4Fe1d7393D8);
    MagicPowerDevsInterface constant private MagicPowerDevs = MagicPowerDevsInterface(0x1A1837C6D259Be9C77080d6e931c8FcE5709C4a0);
    
    MSFun.Data private msData;
    function multiSigDev(bytes32 _whatFunction) private returns (bool) {return(MSFun.multiSig(msData, MagicPowerDevs.requiredDevSignatures(), _whatFunction));}
    ...
    function checkSignersByName(bytes32 _whatFunction, uint256 _signerA, uint256 _signerB, uint256 _signerC) onlyDevs() public view returns(bytes32, bytes32, bytes32) {return(MagicPowerDevs.adminName(MSFun.checkSigner(msData, _whatFunction, _signerA)), MagicPowerDevs.adminName(MSFun.checkSigner(msData, _whatFunction, _signerB)), MagicPowerDevs.adminName(MSFun.checkSigner(msData, _whatFunction, _signerC)));}
//==============================================================================
//     _| _ _|_ _    _ _ _|_    _   .
//    (_|(_| | (_|  _\(/_ | |_||_)  .
//=============================|================================================    
    uint256 public registrationFee_ = 500 finney;            // price to register a name
...
//==============================================================================    
        ...
        public
    {
        ...
        plyr_[1].addr = 0x7d6dcE6Ef707E78131211A45234dD8ac7d09A033;
        plyr_[1].name = "brad";
        plyr_[1].names = 1;
        pIDxAddr_[0x7d6dcE6Ef707E78131211A45234dD8ac7d09A033] = 1;
        pIDxName_["brad"] = 1;
        plyrNames_[1]["brad"] = true;
        plyrNameList_[1][1] = "brad";
        
        plyr_[2].addr = 0x5A3BaE6F3E6704334D6713EB0290deA11730C238;
        plyr_[2].name = "zachary";
        plyr_[2].names = 1;
        pIDxAddr_[0x5A3BaE6F3E6704334D6713EB0290deA11730C238] = 2;
        pIDxName_["zachary"] = 2;
        plyrNames_[2]["zachary"] = true;
        plyrNameList_[2][1] = "zachary";
        
        plyr_[3].addr = 0x125E0Fa6d73DCD198081752295aaC83867fC36e2;
        plyr_[3].name = "bruce";
        plyr_[3].names = 1;
        pIDxAddr_[0x125E0Fa6d73DCD198081752295aaC83867fC36e2] = 3;
        pIDxName_["bruce"] = 3;
        plyrNames_[3]["bruce"] = true;
        plyrNameList_[3][1] = "bruce";
        
        plyr_[4].addr = 0x35F0a9270393B24C826d37914948ec12EC51FFb3;
        plyr_[4].name = "peter";
        plyr_[4].names = 1;
        pIDxAddr_[0x35F0a9270393B24C826d37914948ec12EC51FFb3] = 4;
        pIDxName_["peter"] = 4;
        plyrNames_[4]["peter"] = true;
        plyrNameList_[4][1] = "peter";
...
//==============================================================================    
    ...
    modifier onlyDevs() 
    {
        require(MagicPowerDevs.isDev(msg.sender) == true, "msg sender is not a dev");
        _;
    }
...
//=====================_|=======================================================    
        ...
        private
    {
        ...
        MagicPowerForwarder.deposit.value(address(this).balance)();
...
/**
* @title -Name Filter- v0.0.1© Magic Power Inc. 2018
...
/** @title -MSFun- v0.0.1© Magic Power Inc. 2018
 */
