...
contract etclottery is Lotteryevents{
    ...
    uint8 constant private maxLimit=100;
    ...
    mapping (address => Datasets.Player) private allPlayer;//数组保存当前轮地址，结算的时候清理一次，map里面不清理，没有提现的用户后面需要提现
